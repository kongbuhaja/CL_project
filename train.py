...
for epoch in range(start_epoch+1, epochs+1):
    ...
    train_loss = 0.
    model.train()
    train_tqdm = tqdm.tqdm(train_dataloader, total=train_iters, ncols=121, desc=f'Train epoch {epoch}/{epochs}', ascii=' =', colour='red')
    ...
    if epoch%args.eval_term==0:
        ...
        if best_recall < recalls[-1]:
            ...
            save_model(model, save_path, epoch, recalls[-1])
