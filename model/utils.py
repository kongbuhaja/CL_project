...
def Model(model_name, channel, n_classes, in_channel, image_size, official):
    if model_name == 'DarkNet19':
        model = DarkNet19(channel, n_classes, in_channel, official)
    elif model_name == 'ResNet18':
        model = ResNet18(channel, n_classes, in_channel, official)
    elif model_name == 'VGG11':
        model = VGG11(channel, n_classes, in_channel, image_size, official)
    elif model_name == 'VGG16':
        model = VGG16(channel, n_classes, in_channel, image_size, official)
    elif model_name == 'VGG19':
        model = VGG19(channel, n_classes, in_channel, image_size, official)
    elif model_name == 'GoogleNet22':
        model = GoogleNet22(channel, n_classes, in_channel, official)
...
def load_model(args, n_classes, in_channel=3):
    ...
    model = Model(args.model, args.channel, n_classes, in_channel, args.image_size, args.official)
