...
def load_model(args, n_classes, device='cpu'):
    dir = dir_check(f'{args.checkpoint}/{args.dataset.upper()}/{args.optimizer}/Base/{args.model}') if not args.official else \
          dir_check(f'{args.checkpoint}/{args.dataset.upper()}/{args.optimizer}/Base/official_{args.model}')
