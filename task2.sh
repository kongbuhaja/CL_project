...
task model_train ResNet18 True mnist 0 10 "$log_dir"
task model_train ResNet18 False mnist 0 10 "$log_dir"
task model_train DarkNet19 True mnist 0 10 "$log_dir"
task model_train DarkNet19 False mnist 0 10 "$log_dir"
task model_train GoogleNet22 True mnist 0 10 "$log_dir"
task model_train GoogleNet22 False mnist 0 10 "$log_dir"
